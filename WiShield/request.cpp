...
// To get the ip address of supertweet.net, you might want to:
// ping api.supertweet.net
// and use what ever ip address is used by ping.  Below is the one that
// works for me.  It depends on where you are and they might change their ip.
uint8 twitterIP[] = {66, 180, 175, 246};
char twitterHost[] = {"api.supertweet.net"};
char twitterURL[] = {"/1/statuses/update.xml"};
