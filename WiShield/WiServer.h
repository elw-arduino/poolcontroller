...
class Server: public Print
{
	public:
		...
		/**
 		 * Add by Mohrgan, taken from post:
 		 * http://asynclabs.com/forums/viewtopic.php?f=19&t=263&hilit=sendInProgress&start=10#p2129
		 * @return true if this is the first call to send page function
		 */
		boolean firstCall ();
		...
		/*
 		 * Add a way to chack to see if WiShield is connected
 		 * Added by Mohrgan.
 		 */
//		bool Connected ();
